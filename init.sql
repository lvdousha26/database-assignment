...
CREATE TABLE tb_cost (
  code CHAR(20) NOT NULL PRIMARY KEY COMMENT '费用编号',
  preunit VARCHAR(50) NOT NULL COMMENT '预算单位',
  wellcode VARCHAR(50) NOT NULL COMMENT '井号',
  premoney DECIMAL(14,2) COMMENT '预算总金额',
  person VARCHAR(50) COMMENT '预算编制人',
  predate DATE NOT NULL COMMENT '预算编制日期',
  startdate DATE COMMENT '工程开工日期',
  finish DATE COMMENT '工程完工日期',
  settleunit VARCHAR(100) NOT NULL COMMENT '施工/结算单位',
  content VARCHAR(100) COMMENT '作业内容',
  mat1_code CHAR(20), mat1_num INT DEFAULT 0, mat1_price DECIMAL(14,2), mat1_sub DECIMAL(14,2),
  mat2_code CHAR(20), mat2_num INT DEFAULT 0, mat2_price DECIMAL(14,2), mat2_sub DECIMAL(14,2),
  mat3_code CHAR(20), mat3_num INT DEFAULT 0, mat3_price DECIMAL(14,2), mat3_sub DECIMAL(14,2),
  mat4_code CHAR(20), mat4_num INT DEFAULT 0, mat4_price DECIMAL(14,2), mat4_sub DECIMAL(14,2),
  matcost DECIMAL(14,2) DEFAULT 0 COMMENT '材料总成本',
  humancost DECIMAL(14,2) DEFAULT 0 COMMENT '人工成本',
  equipcost DECIMAL(14,2) DEFAULT 0 COMMENT '设备成本',
  othercost DECIMAL(14,2) DEFAULT 0 COMMENT '其他成本',
  settlecost DECIMAL(14,2) DEFAULT 0 COMMENT '结算总金额',
  settleperson CHAR(20) COMMENT '结算经办人',
  settledate DATE COMMENT '结算日期',
  finalcost DECIMAL(14,2) COMMENT '终审金额',
  finalperson CHAR(20) COMMENT '终审人',
  finaldate DATE COMMENT '终审日期'
...
CREATE TABLE tb_dynamic (
  ...
  images VARCHAR(2000) COMMENT '图片路径',
  created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
